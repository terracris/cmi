...
home_count_j2 = -145 # need to tune
max_speed_j2 = 75    # need to tune
...
home_count_j3 = -350 # need to tune 
max_speed_j3 = 75
max_positive_angle_j3 = 80  
max_negative_angle_j3 = -80  
homing_direction_j3 = Stepper.CCW
